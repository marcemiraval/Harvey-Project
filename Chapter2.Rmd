...
```{r create_hexagonal_grid_polygon, include=FALSE, echo=FALSE}
sf_sandy_states <-  as(sandy_boundary, "Spatial")

nHex <- c(100, 200, 400, 600, 800)

sp_hex = SpatialPolygonsDataFrame(SpatialPolygons(list()), data=data.frame())
