...
```{r load_data}
load(file= "sandy_boundary.RData")
load(file = "sandySpotIn_sf.RData")
load(file = "sandyTweetsIn_sf.RData")
```
...
sp_hexTweets <- HexPoints2SpatialPolygons(spsample(spSandyTweets, type="hexagonal", cellsize =1000))
plot(sp_hexTweets)
```
