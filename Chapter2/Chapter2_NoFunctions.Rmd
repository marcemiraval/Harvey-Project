...
pal1 <- brewer.pal(6, "YlOrRd")
palData <- classIntervals(hexWithSpoReports$total, n=6, style="jenks")
...
palData <- classIntervals(hexWithSpoReports$total, n = 7, style="jenks", pal = pal1)
hexWithSpoReports$colores <- findColours(palData, pal1)
