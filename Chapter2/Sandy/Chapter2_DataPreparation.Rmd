...
```{r}
save(sandy_boundary, file="Data/sandy_boundary.RData")
save(sandySpotIn_sf, file="Data/sandySpotIn_sf.RData")
save(sandyTweetsIn_sf, file="Data/sandyTweetsIn_sf.RData")
```
