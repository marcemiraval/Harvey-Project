...
nHex <- c(h500 = 500, h1000 = 1000, h1500 = 1500, h2000 = 2000, 
...
load(file= "Data/TotalsSpotters.RData")
load(file = "Data/TotalsTweets.RData")
```
...
SandyReportsMap <- leaflet(sandyTweetsIn_sf) %>% 
  ...
  addProviderTiles(providers$OpenStreetMap.BlackAndWhite)%>% 
      ...
      addCircles(data = sandySpotIn_sf, weight = 3, radius=40,
