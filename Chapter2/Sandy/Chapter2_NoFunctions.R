...
#' 
#' 
## ----load_packages, include=FALSE, echo=FALSE----------------------------
library(tidyverse)
library(sf)
library(sp)
library(rgeos)
...
#' 
#' 
## ----create_hexagonal_boundary_grid_proj, include=FALSE, echo=FALSE------
...
sp_hex100000 <- HexPoints2SpatialPolygons(spsample(sandy_boundary_sp, 
                                              type = "hexagonal", 
...
sf_hex100000 <- st_as_sf(sp_hex100000) %>% 
  mutate(group = 1:nrow(.))
...
ggplot(data = sf_hex100000) + geom_sf() + 
  coord_sf(xlim = c(937758.7, 2137758.7), 
           ylim = c(-256887.3, 1114319.6),
           datum = st_crs(projSandy),
...
#' 
## ----create_hexagonal_grid_points, include=FALSE, echo=FALSE-------------
...
#' 
## ----project_data_planarCS, include=FALSE, echo=FALSE--------------------
...
#' 
## ----join_hex_and_Reports, include=FALSE, echo=FALSE---------------------
...
#' 
## ----compute_sd, include= FALSE, echo=FALSE------------------------------
...
#' 
#' 
## ----export_shps, include=FALSE, echo=FALSE, eval = FALSE----------------
...
## st_write(sandySpotIn_sf, "Data/sandySpotReports.shp",
##          layer_options = "GEOMETRY=AS_XY", delete_layer = TRUE)

#' 
## ----map_Sandy_reports, echo=FALSE, eval=FALSE---------------------------
...
#' 
## ----mapHexSandy_spotters, warning= FALSE, echo=FALSE, message= FALSE----
classes <- 6
style_method <- "fisher"
...
#' 
## ----mapHexSandy_spotters_Norm, warning= FALSE, echo=FALSE, message= FALSE----
classes <- 6
style_method <- "fisher"
pal1 <- brewer.pal(classes, "YlOrRd")
...
#' ***  
#' 
## ----mapHexSandy_Tweets, warning= FALSE, echo=FALSE, message= FALSE------
classes <- 7
style_method <- "fisher"
pal1 <- brewer.pal(classes, "YlOrRd")
...
#' 
## ----mapHexSandyNormTweets, warning= FALSE, echo=FALSE, message= FALSE----
classes <- 7
style_method <- "fisher"
pal1 <- brewer.pal(classes, "YlOrRd")
...
#' ***  
#' 
## ----create_hists_Tweets, warning= FALSE, echo=FALSE, message= FALSE-----
