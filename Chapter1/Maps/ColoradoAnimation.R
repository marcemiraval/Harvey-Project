...
Colorado=read.csv("ColoradoFloodOriginal.csv")
...
Colorado=Colorado[-c(4)]

Coloradomap <-ggplot(Colorado, aes(x=longitude, y=latitude, frame=date))+
  ...
  theme(axis.line=element_blank(),
        ...
        plot.title = element_text(family="Garamond", hjust=0.5,lineheight=.8, colour = "white",size=16))


gganimate(Coloradomap,ani.width=1200, ani.height=800,interval=0.15,"colorado.gif")  
