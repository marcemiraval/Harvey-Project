...
# Loading data into R
sandy <- read.csv("Sandy_Subset.csv", header = TRUE, sep = ",")
...
write.csv(sandy, file = "Sandy_Subset_Clean.csv")
...
sandy$event_stage = "" # Initialize Variable
...
sandy$event_stage[sandy$created_at >= "2012-10-28 02:00:00 UTC" & sandy$created_at <
                    "2012-10-29 02:30:00 UTC"] = "PrePeak"
sandy$event_stage[sandy$created_at >= "2012-10-29 02:30:00 UTC" & sandy$created_at <
                    "2012-10-30 02:30:00 UTC"] = "Peak"
sandy$event_stage[sandy$created_at >= "2012-10-30 02:30:00 UTC" & sandy$created_at <
                    "2012-10-31 02:30:00 UTC"] = "PostPeak"
sandy$event_stage[sandy$created_at >= "2012-10-31 02:30:00 UTC" & sandy$created_at <=
                    max_datetime] = "PostCalm"

count(sandy, event_stage)

# creating frequency histograms of reports colored by stage (using create_histo function)

OutputsFile <- "/home/marcela/Coding/EWE-reporting/Sandy/EastCoast/Outputs/"
...
ggplot(sandy, aes(x = sandy$created_at,  fill = factor(sandy$event_stage))) +
  geom_histogram(aes(y = ..count..), colour = NA, binwidth = 3600, 
...
create_dendogram(DTMInput = dtm_PreCalm, sparceFactor = 0.98, nclusters =9, 
                 OutFolder = OutputsFile,
                 OutFile = "Dendogram_PreCalm.png",
                 palette = "Set3")

create_dendogram(DTMInput = dtm_PrePeak, sparceFactor = 0.98, nclusters =6, 
                 OutFolder = OutputsFile,
...
create_dendogram(DTMInput = dtm_PostPeak, sparceFactor = 0.98, nclusters =9, 
                 OutFolder = OutputsFile,
                 OutFile = "Dendogram_PostPeak.png",
                 palette = "Set3")

create_dendogram(DTMInput = dtm_PostCalm, sparceFactor = 0.98, nclusters =8, 
                 OutFolder = OutputsFile,
