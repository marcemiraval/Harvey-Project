...
```{r gamma_plot, echo=FALSE, message=FALSE}
...
From the plot above, we can see that more probably each tweet is associated with a single topic. Gamma probabilities tell us which topics are coming from which documents (tweets).
