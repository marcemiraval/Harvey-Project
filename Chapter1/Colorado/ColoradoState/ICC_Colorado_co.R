...
# Loading data into R
colorado <- read.csv("Colorado_Subset.csv", header = TRUE, sep = ",")
...
OutputsFile <- "/home/marcela/Coding/EWE-reporting/Colorado/ColoradoState/Outputs/"
...
ToExclude <- c("boulderflood", "flood", "boulder", "mdt", "colorado", "coflood", "like",
               ...
               "safe", "see", "look", "morn", "issu", "dont", "lol", "gjco")
...
create_wordcloud(DTMInput = dtm_colpre, sparceFactor = 0.999999999999,
                 OutFolder = OutputsFile,
                 OutFile = "WordcloudPreColorado1.png", background = "transparent", 
...
create_wordcloud(DTMInput = dtm_colFlood, sparceFactor = 0.999999999999,
                 OutFolder = OutputsFile,
                 OutFile = "WordcloudFloodColorado1.png", background = "transparent", 
...
create_wordcloud(DTMInput = dtm_col_ia, sparceFactor = 0.999999999999,
                 OutFolder = OutputsFile,
                 OutFile = "WordcloudIAftermathColorado.png", background = "transparent", 
                 ncolors = 6, palette = "Dark2")

dtm_col_post <-  DocumentTermMatrix(post_co_corpus)
create_wordcloud(DTMInput = dtm_col_post, sparceFactor = 0.999999999999,
                 OutFolder = OutputsFile,
                 OutFile = "WordcloudPostColorado.png", background = "transparent", 
                 ncolors = 6, palette = "Dark2")
...
create_dendogram(DTMInput = dtm_colpre, sparceFactor = 0.98, nclusters = 11, 
                 OutFolder = OutputsFile,
                 OutFile = "Dendogram_colpre.png",
                 palette = "Set3")

create_dendogram(DTMInput = dtm_colFlood, sparceFactor = 0.98, nclusters = 5, 
                 OutFolder = OutputsFile,
                 OutFile = "Dendogram_colFlood.png",
                 palette = "Accent")

create_dendogram(DTMInput = dtm_col_ia, sparceFactor = 0.98, nclusters = 12, 
                 OutFolder = OutputsFile,
                 OutFile = "Dendogram_col_ia.png",
                 palette = "Set3")

create_dendogram(DTMInput = dtm_col_post, sparceFactor = 0.98, nclusters = 6, 
                 OutFolder = OutputsFile,
