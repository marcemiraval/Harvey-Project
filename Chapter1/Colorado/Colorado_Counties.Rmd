...
k_result_county %>%
  ...
  filter(K %in% c(2,3,4,5,6,7,8,9,10)) %>% # This values should be the same used when creating the model in the R script
  unnest() %>%
...
```{r gammaclusters2_heatplot, echo=FALSE, message=FALSE, fig.width=10, fig.height=10}
