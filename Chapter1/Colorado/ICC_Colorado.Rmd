...
create_wordcloud <- function(stage, clusterID){
  ...
  colo_tweets <- colo_clusters_wgs84 %>%
    filter(cluster == clusterID | flood_stage == stage) %>% 
...
#### **Wordclouds for Denver**

```{r word_Denver, message=FALSE}

lapply(stages, create_wordcloud, clusterID = "1")
...
#### **Wordclouds for Boulder**

```{r word_Boulder, message=FALSE}

lapply(stages, create_wordcloud, clusterID = "2")
