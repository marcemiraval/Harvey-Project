...
clusters_floodAndIA_sparse <- readRDS(file = "clusters_floodAndIA_sparse.rds") #it didn't work with sparce just with dfm

clusters_floodAndIA_dfm <- readRDS(file = "clusters_floodAndIA_dfm.rds")
...
saveRDS(k_result_floodAndIA_clusters, file = "k_result_floodAndIA_clusters.rds")
